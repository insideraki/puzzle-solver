...
const STRINGS = {
  ...
  zh: {
    ...
    err: '发生错误，请重试',
    share: '分享',
    tweet: '#PuzzlesAndSurvival 英雄技能优化工具 https://puzzle-solver-bice.vercel.app',
    weibo: '微博',
  ...
  ko: {
    ...
    share: '공유',
    tweet: '#PuzzlesAndSurvival #파즐앤서바이벌 영웅 특기 최적화 도구 https://puzzle-solver-bice.vercel.app',
